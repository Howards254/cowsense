...
import {
  LayoutDashboard, Users, Brain, Lightbulb, Package, CalendarCheck,
  ClipboardList, BarChart3, Settings, Sprout,
} from "lucide-react";
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 border-r border-sidebar-border bg-sidebar h-screen sticky top-0">
      <div className="px-5 h-16 flex items-center gap-2 border-b border-sidebar-border">
        <div className="size-9 rounded-xl grid place-items-center text-primary-foreground" style={{ background: "var(--gradient-primary)" }}>
